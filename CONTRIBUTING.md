...
* What you are doing?
  ...
  * What do you expect to happend?
  * What is actually happening?
* Which testlenium version are you using?
...
* Make sure you followed [coding guidelines](https://github.com/red-panda-ci/testlenium/blob/master/CONTRIBUTING.md#coding-guidelines)
...
You can run all tests in your workstations as if they run in our Jenkins.

### 3. Check the documentation

There is a `make` command to generate the main README.md file that you can run (in the 'testlenium' dir)
